...
const SPECS = Object.freeze({
  ...
  'kacirilan-sgk-tesvikleri-ve-gercek-iscilik-maliyeti-analizi': {
    ...
    ornek: [
      ['Çalışan 1', 42000, 42000, 0.05, 'Hayır'],
      ['Çalışan 2', 38000, 38000, 0.05, 'Evet'],
      ['Çalışan 3', 51000, 51000, 0.035, 'Hayır'],
      ['Çalışan 4', 36000, 36000, 0.05, 'Hayır'],
      ['Çalışan 5', 47000, 47000, 0.035, 'Evet'],
    ],
    metrikler: [
      ...
      ['Demo karar', '=IF(B9>B7*0.5,"DURDUR",IF(B9>10000,"İNCELE","UYGUN"))', 'metin'],
    ],
  ...
  'kidem-ihbar-yuku-ve-personel-cikarma-maliyeti-hesaplayici': {
    ...
    ornek: [
      ['Çalışan 1', 6, 42000, 252000, 42000],
      ['Çalışan 2', 3, 38000, 114000, 38000],
      ['Çalışan 3', 11, 51000, 561000, 102000],
      ['Çalışan 4', 2, 36000, 72000, 36000],
    ],
    metrikler: [
  ...
  'fazla-mesai-ve-isci-dava-riski-tespit-dosyasi': {
    ...
    ornek: [
      ['Çalışan 1', 42000, 45, 18000, 5000],
      ['Çalışan 2', 38000, 28, 12000, 0],
      ['Çalışan 3', 51000, 62, 15000, 22000],
    ...
    metrikler: [
      ...
      ['Demo karar', '=IF(B9>0.3,"DURDUR",IF(B8>15000,"İNCELE","UYGUN"))', 'metin'],
    ],
