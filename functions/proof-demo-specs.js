...
const SPECS = Object.freeze({
  ...
  'cari-hesap-tahsilat-ve-musteri-risk-takip-sistemi': {
    ...
    ornek: [
      ['Alfa Yapı', 85000, 35, 25000, 40000],
      ['Beta Tekstil', 32000, 7, 0, 12000],
      ['Gama Gıda', 120000, 18, 45000, 30000],
      ['Delta İnşaat', 18000, 0, 0, 18000],
      ['Epsilon Ltd.', 54000, 28, 15000, 20000],
    ],
    metrikler: [
  ...
  'banka-kredi-ve-taksit-takip-sistemi': {
    ...
    ornek: [
      ['Banka A - İşletme', 420000, 32000, 5, 95000],
      ['Banka B - Spot', 260000, 24000, 12, 95000],
      ['Banka C - Taşıt', 145000, 16000, 20, 95000],
      ['Finansman - Ekipman', 98000, 12000, 8, 95000],
      ['Banka D - Kobi Destek', 180000, 11000, 25, 95000],
    ],
    metrikler: [
      ...
      ['Demo karar', '=IF(B9>1,"DURDUR",IF(B9>0.6,"İNCELE","UYGUN"))', 'metin'],
    ],
  ...
  'cek-senet-ve-vade-risk-sistemi': {
    ...
    ornek: [
      ['12.08.2026', 'Çek-001', 48000, 40000, 'Bekliyor'],
      ['14.08.2026', 'Çek-002', 72000, 60000, 'Bekliyor'],
      ['14.08.2026', 'Senet-003', 55000, 45000, 'Bekliyor'],
      ['28.08.2026', 'Çek-004', 32000, 32000, 'Hazır'],
      ['02.09.2026', 'Senet-005', 64000, 55000, 'Bekliyor'],
    ],
    metrikler: [
  ...
  'vergi-sgk-ve-maas-karsilik-ayirma-sistemi': {
    ...
    ornek: [
      ...
      ['Ekim', 260000, 56000, 116000, 16000],
      ['Kasım', 240000, 53000, 110000, 15000],
      ['Aralık', 230000, 50000, 108000, 14000],
    ],
    metrikler: [
  ...
  'stok-satis-ve-nakit-baglanma-sistemi': {
    ...
    ornek: [
      ['Ürün A', 95000, 45000, 0.28, 12],
      ['Ürün B', 42000, 68000, 0.34, 8],
      ['Ürün C', 120000, 15000, 0.22, 25],
      ['Ürün D', 28000, 51000, 0.31, 5],
      ['Ürün E', 76000, 38000, 0.18, 18],
    ],
    metrikler: [
      ...
      ['Satışı çok düşük ürün', '=COUNTIF(DEMO_GIRIS!C6:C25,"<20000")', 'sayi'],
      ['Demo karar', '=IF(B8>2,"DURDUR",IF(B9>=1,"İNCELE","UYGUN"))', 'metin'],
    ],
  ...
  'kobi-finans-yonetim-paketi': {
    ...
    ornek: [
      ['Kullanılabilir nakit', 90000, 100000, '', 'Kasa'],
      ['30 gün tahsilat', 260000, 220000, '', 'Cari'],
      ['30 gün ödeme', 240000, 250000, '', 'Ödeme'],
      ['Aylık taksit', 80000, 85000, '', 'Kredi'],
      ['Vergi+SGK+maaş', 168000, 160000, '', 'Karşılık'],
      ['Stok bağlanması', 190000, 200000, '', 'Stok'],
    ],
    metrikler: [
  ...
  'asiri-dusuk-teklif-savunma-robotu': {
    ...
    girisBasliklari: ['Kalem', 'Maliyet (₺)', 'Belge durumu', 'Açıklama dahil mi', 'Not'],
    ornek: [
      ['Malzeme', 185000, 'Belgeli', 'Evet', ''],
      ['İşçilik', 96000, 'Belgeli', 'Evet', ''],
      ['Makine', 42000, 'Belgesiz', 'Hayır', ''],
      ['Nakliye', 18000, 'Belgeli', 'Evet', ''],
      ['Genel gider', 30000, 'Belgesiz', 'Hayır', ''],
    ],
    metrikler: [
      ['Toplam açıklama maliyeti', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Açıklama kapsamındaki tutar', '=SUMPRODUCT(--(DEMO_GIRIS!D6:D25="Evet"),DEMO_GIRIS!B6:B25)', 'para'],
      ['Belgesiz kalem tutarı', '=SUMPRODUCT(--(DEMO_GIRIS!C6:C25="Belgesiz"),DEMO_GIRIS!B6:B25)', 'para'],
      ['Açıklama kapsama oranı', '=IFERROR(B7/B6,0)', 'oran'],
      ['Demo karar', '=IF(B8>B6*0.25,"DURDUR",IF(B9<0.75,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Belgesiz ve kapsam dışı kalemleri açıklamaya ekle.', 'Açıklama tutarını sınır değerin altında kalan bölümle karşılaştır.', 'Tam sürümde sınır hesapları, endeks farkı ve ihale kararı motoru birlikte çalışır.'],
  },
  'ihaleye-kac-tl-teklif-vermeliyim': {
    karar: 'Rakip teklifler üzerinden sınır değeri ve önerilen teklif aralığını gösterir.',
    girisBasliklari: ['Teklif veren', 'Teklif (₺)', 'Yaklaşık maliyet (₺)', 'Aralık durumu', 'Not'],
    ornek: [
      ['Firma A', 1180000, 1200000, 'Üst bölge', ''],
      ['Firma B', 1320000, 1200000, 'Üst bölge', ''],
      ['Firma C', 1040000, 1200000, 'Alt bölge', ''],
      ['Firma D', 960000, 1200000, 'Aşırı düşük', ''],
      ['Firma E', 1250000, 1200000, 'Üst bölge', ''],
    ],
    metrikler: [
      ['Ortalama rakip teklif', '=AVERAGE(DEMO_GIRIS!B6:B25)', 'para'],
      ['Sınır değer (tahmini)', '=IFERROR(B6*0.92,0)', 'para'],
      ['Önerilen alt sınır', '=IFERROR(B7*0.95,0)', 'para'],
      ['Aşırı düşük sayısı', '=COUNTIF(DEMO_GIRIS!D6:D25,"Aşırı düşük")', 'sayi'],
      ['Demo karar', '=IF(B9>=1,"İNCELE",IF(B8>1200000,"DURDUR","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Sınır değerin altındaki teklifler aşırı düşük sorgusu riski taşır.', 'Önerilen aralığı kâr hedefinle karşılaştır.', 'Tam sürümde önceki ihale trendi, maliyet motoru ve senaryo analizi açılır.'],
  },
  'hakedis-fiyat-farki-hak-kaybi-cetveli': {
    karar: 'Hakediş fiyat farkını ve endeks kaynaklı hak kaybını gösterir.',
    girisBasliklari: ['Dönem', 'Hakediş (₺)', 'Sözleşme endeks', 'Güncel endeks', 'Katsayı'],
    ornek: [
      ['Haziran', 240000, 220.4, 231.8, 0.8],
      ['Temmuz', 265000, 220.4, 238.1, 0.8],
      ['Ağustos', 250000, 220.4, 245.6, 0.8],
      ['Eylül', 280000, 220.4, 252.2, 0.8],
    ],
    metrikler: [
      ['Toplam hakediş', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Ortalama endeks artışı', '=IFERROR(AVERAGE(DEMO_GIRIS!D6:D25)/AVERAGE(DEMO_GIRIS!C6:C25)-1,0)', 'oran'],
      ['Hesaplanan fiyat farkı', '=SUM(DEMO_GIRIS!B6:B25)*(B7)*AVERAGE(DEMO_GIRIS!E6:E25)', 'para'],
      ['Endeks farkı oranı', '=IFERROR(B8/MAX(B6,1),0)', 'oran'],
      ['Demo karar', '=IF(B9>0.15,"DURDUR",IF(B8<10000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Endeks artışını sözleşme hükmüyle eşleştir.', 'Hesaplanan fiyat farkını hakedişe yansıt.', 'Tam sürümde dönem bazlı fark, hak kaybı ve rapor motoru açılır.'],
  },
  'yillara-sari-insaat-stopaj-nakit-akis-planlayici': {
    karar: 'Dönem stopaj yükünü ve nakit akışı açığını gösterir.',
    girisBasliklari: ['Dönem', 'Hakediş (₺)', 'Stopaj oranı', 'Tahsilat (₺)', 'Ödeme (₺)'],
    ornek: [
      ['2026 Q3', 320000, 0.05, 290000, 260000],
      ['2026 Q4', 410000, 0.05, 380000, 350000],
      ['2027 Q1', 480000, 0.05, 300000, 360000],
      ['2027 Q2', 520000, 0.05, 470000, 430000],
    ],
    metrikler: [
      ['Toplam hakediş', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam stopaj', '=SUMPRODUCT(DEMO_GIRIS!B6:B25,DEMO_GIRIS!C6:C25)', 'para'],
      ['Net nakit (tahsilat-ödeme)', '=SUM(DEMO_GIRIS!D6:D25)-SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Stopaj / nakit oranı', '=IFERROR(B7/MAX(B8,1),0)', 'oran'],
      ['Demo karar', '=IF(B8<0,"DURDUR",IF(B9>0.5,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Stopaj ödeme tarihlerini tahsilatla eşleştir.', 'Nakit açığı dönemlerinde finansman planı oluştur.', 'Tam sürümde yıllık plan, vergi planı ve nakit köprüsü motoru açılır.'],
  },
  'taseron-hakedis-kesinti-mutabakati': {
    karar: 'Taşeron hakedişi ile yapılan ödeme arasındaki mutabakat farkını gösterir.',
    girisBasliklari: ['Taşeron', 'Hakediş (₺)', 'Kesinti (₺)', 'Ödenen (₺)', 'Fark (₺)'],
    ornek: [
      ['Taşeron A', 185000, 25000, 155000, '=B6-C6-D6'],
      ['Taşeron B', 96000, 12000, 80000, '=B7-C7-D7'],
      ['Taşeron C', 132000, 18000, 118000, '=B8-C8-D8'],
      ['Taşeron D', 74000, 9000, 68000, '=B9-C9-D9'],
    ],
    metrikler: [
      ['Toplam hakediş', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam kesinti', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Toplam ödenen', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Toplam mutabakat farkı', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Demo karar', '=IF(ABS(B9)>B6*0.05,"DURDUR",IF(ABS(B9)>1000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Fark tutarı taşeron hakedişinde işaretle.', 'Kesinti kalemlerini sözleşme hükümleriyle doğrula.', 'Tam sürümde taşeron bazlı mutabakat ve ihtilaf erken uyarısı açılır.'],
  },
  'kacirilan-sgk-tesvikleri-ve-gercek-iscilik-maliyeti-analizi': {
    ...
    girisBasliklari: ['Çalışan', 'Brüt ücret (₺)', 'SGK matrahı (₺)', 'Teşvik oranı', 'Kullanılıyor mu'],
    ornek: [
      ['Çalışan 1', 42000, 42000, 0.05, 'Evet'],
      ['Çalışan 2', 38000, 38000, 0.05, 'Evet'],
      ['Çalışan 3', 51000, 51000, 0.035, 'Hayır'],
      ['Çalışan 4', 36000, 36000, 0.05, 'Evet'],
      ['Çalışan 5', 47000, 47000, 0.035, 'Hayır'],
    ],
    metrikler: [
      ['Toplam SGK matrahı', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Yararlanılabilir teşvik', '=SUMPRODUCT(DEMO_GIRIS!C6:C25,DEMO_GIRIS!D6:D25)', 'para'],
      ['Kullanılan teşvik', '=SUMPRODUCT((DEMO_GIRIS!E6:E25="Evet")*DEMO_GIRIS!C6:C25*DEMO_GIRIS!D6:D25)', 'para'],
      ['Kaçırılan teşvik', '=B7-B8', 'para'],
      ['Demo karar', '=IF(B9>B7*0.5,"DURDUR",IF(B9>B7*0.15,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Kullanılmayan teşvik kodlarını SGK beyanına ekle.', 'Teşvik oranlarını dönem bazında doğrula.', 'Tam sürümde çalışan bazlı gerçek işçilik maliyeti ve teşvik simülatörü açılır.'],
  },
  'kidem-ihbar-yuku-ve-personel-cikarma-maliyeti-hesaplayici': {
    ...
    girisBasliklari: ['Çalışan', 'Hizmet yılı', 'Brüt ücret (₺)', 'Kıdem tazminatı (₺)', 'İhbar tazminatı (₺)'],
    ornek: [
      ['Çalışan 1', 2, 38000, 76000, 38000],
      ['Çalışan 2', 1, 36000, 36000, 36000],
      ['Çalışan 3', 3, 42000, 126000, 42000],
      ['Çalışan 4', 1, 34000, 34000, 34000],
    ],
    metrikler: [
      ['Toplam kıdem tazminatı', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Toplam ihbar tazminatı', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Toplam çıkarma maliyeti', '=B6+B7', 'para'],
      ['En yüksek tek çalışan yükü', '=MAX(DEMO_GIRIS!D6:D25)', 'para'],
      ['Demo karar', '=IF(B8>500000,"DURDUR",IF(B8>200000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Uzun kıdemli çalışanlarda çıkarma maliyetini ayrıca değerlendir.', 'İhbar süresi bildirimi ile ihbar tazminatını karşılaştır.', 'Tam sürümde kıdem tavanı, tazminat hesabı ve toplu çıkarma senaryosu açılır.'],
  },
  'fazla-mesai-ve-isci-dava-riski-tespit-dosyasi': {
    karar: 'Fazla mesai karşılığını ve işçi alacağı riskini gösterir.',
    girisBasliklari: ['Çalışan', 'Brüt ücret (₺)', 'Aylık fazla mesai (saat)', 'Ödenen (₺)', 'Eksik ödeme (₺)'],
    ornek: [
      ['Çalışan 1', 42000, 45, 18000, 3000],
      ['Çalışan 2', 38000, 28, 12000, 0],
      ['Çalışan 3', 51000, 62, 15000, 7000],
      ['Çalışan 4', 36000, 15, 8000, 0],
    ],
    metrikler: [
      ['Toplam fazla mesai karşılığı', '=SUM(DEMO_GIRIS!C6:C25)* (AVERAGE(DEMO_GIRIS!B6:B25)/225)*1.5', 'para'],
      ['Toplam ödenen', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Toplam eksik ödeme', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Eksik ödeme oranı', '=IFERROR(B8/MAX(B6,1),0)', 'oran'],
      ['Demo karar', '=IF(B9>0.35,"DURDUR",IF(B8>8000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Eksik ödeme olan çalışanları öncelikli dava riski olarak işaretle.', 'Aylık fazla mesai kayıtlarını sözleşmeyle doğrula.', 'Tam sürümde saat sınırı, anomali ve dava riski motoru birlikte çalışır.'],
  },
  'asgari-ucret-zam-etkisi-fiyat-ayarlama-cetveli': {
    ...
    girisBasliklari: ['Ürün', 'Satış fiyatı (₺)', 'İşçilik payı (₺)', 'Zam etkisi %', 'Yeni fiyat (₺)'],
    ornek: [
      ['Ürün A', 890, 310, 0.10, '=B6*(1+D6)'],
      ['Ürün B', 1490, 520, 0.10, '=B7*(1+D7)'],
      ['Ürün C', 640, 220, 0.10, '=B8*(1+D8)'],
      ['Ürün D', 1990, 640, 0.10, '=B9*(1+D9)'],
    ],
    metrikler: [
      ['Toplam işçilik payı', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Zam sonrası işçilik payı', '=B6*(1+AVERAGE(DEMO_GIRIS!D6:D25))', 'para'],
      ['Zam kaynaklı maliyet artışı', '=B7-B6', 'para'],
      ['Ortalama yeni fiyat', '=AVERAGE(DEMO_GIRIS!E6:E25)', 'para'],
      ['Demo karar', '=IF(B8/B6>0.15,"DURDUR",IF(B8/B6>0.05,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Zam etkisini ürün bazlı fiyata yansıt.', 'İşçilik yoğun ürünlerde fiyat artışını önceliklendir.', 'Tam sürümde çalışan bazlı maliyet, SGK yükü ve senaryo motoru açılır.'],
  },
  'ithalat-depo-teslim-rafa-gelen-net-birim-maliyet': {
    ...
    girisBasliklari: ['Ürün', 'FOB (₺)', 'CIF (₺)', 'Vergi toplam (₺)', 'Net birim maliyet (₺)'],
    ornek: [
      ['Ürün A', 2400, 2650, 1180, 3960],
      ['Ürün B', 850, 940, 420, 1490],
      ['Ürün C', 5200, 5750, 2560, 8790],
      ['Ürün D', 1360, 1490, 660, 2410],
    ],
    metrikler: [
      ['Toplam FOB', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam vergi', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Vergi / CIF oranı', '=IFERROR(B7/SUM(DEMO_GIRIS!C6:C25),0)', 'oran'],
      ['Ortalama net birim maliyet', '=AVERAGE(DEMO_GIRIS!E6:E25)', 'para'],
      ['Demo karar', '=IF(B8>0.55,"DURDUR",IF(B9>3000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Vergi yükü yüksek ürünlerde fiyatlamayı yeniden değerlendir.', 'CIF ve yurt içi masrafları ürün bazında doğrula.', 'Tam sürümde gümrük, ÖTV, KDV kademeli hesabı ve yurt içi masraf dağıtımı açılır.'],
  },
  'yeniden-degerleme-yapmali-miyim-vergi-tasarruf-analizi': {
    ...
    girisBasliklari: ['Kıymet', 'Maliyet (₺)', 'Katsayı', 'Değer artışı (₺)', 'Net tasarruf (₺)'],
    ornek: [
      ['Makine 1', 850000, 1.42, 357000, 42500],
      ['Makine 2', 420000, 1.38, 159600, 18600],
      ['Bina 1', 2500000, 1.51, 1275000, 152000],
      ['Taşıt 1', 380000, 1.24, 91200, 10400],
    ],
    metrikler: [
      ['Toplam maliyet', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam değer artışı', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Fon vergisi (%2)', '=B7*0.02', 'para'],
      ['Toplam net tasarruf', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Demo karar', '=IF(B9>B8,"UYGUN",IF(B9>B8*0.7,"İNCELE","DURDUR"))', 'metin'],
    ],
    aksiyonlar: ['Net tasarrufu pozitif kıymetlerde yeniden değerlemeyi değerlendir.', 'Katsayı ve oranları güncel mevzuatla doğrula.', 'Tam sürümde kıymet bazlı yıl ve ömür hesabı, senaryo ve karar motoru açılır.'],
  },
  'vergi-sgk-borcunu-tecil-etmeli-miyim-kredi-mi-tecil-mi': {
    ...
    girisBasliklari: ['Borç', 'Asıl (₺)', 'Zam (₺)', 'Tecil taksit', 'Toplam ödeme (₺)'],
    ornek: [
      ['Vergi borcu', 480000, 86400, 24, 597600],
      ['SGK borcu', 315000, 47250, 12, 382725],
      ['Kira tevkifatı', 96000, 12480, 6, 113280],
      ['Motorlu taşıt', 42000, 5880, 12, 50148],
    ],
    metrikler: [
      ['Toplam asıl', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam zam', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Toplam ödeme', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Kredi maliyeti (örnek)', '=B6*1.18', 'para'],
      ['Demo karar', '=IF(B9<B8,"UYGUN",IF(B9<B8*1.05,"İNCELE","DURDUR"))', 'metin'],
    ],
    aksiyonlar: ['En düşük maliyetli seçeneği borç bazında değerlendir.', 'Kredi faiz oranını güncel piyasa ile doğrula.', 'Tam sürümde NBD, vade ve taksit planı senaryoları açılır.'],
  },
  'sirket-oz-kaynagi-eridi-mi-ttk-376-sermaye-tamamlama-cetveli': {
    ...
    girisBasliklari: ['Dönem', 'Sermaye (₺)', 'Öz kaynak (₺)', 'Kayıp (₺)', 'Kayıp oranı'],
    ornek: [
      ['Oca 2026', 2000000, 1750000, 250000, '=D6/B6'],
      ['Şub 2026', 2000000, 1480000, 520000, '=D7/B7'],
      ['Mar 2026', 2000000, 1260000, 740000, '=D8/B8'],
      ['Nis 2026', 2000000, 1080000, 920000, '=D9/B9'],
    ],
    metrikler: [
      ['Toplam kayıp', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Son dönem kayıp oranı', '=IFERROR(DEMO_GIRIS!D9/DEMO_GIRIS!B9,0)', 'oran'],
      ['2/3 eşiği', '=2/3', 'oran'],
      ['1/3 eşiği', '=1/3', 'oran'],
      ['Demo karar', '=IF(B7>=B8,"DURDUR",IF(B7>=B9,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Kayıp oranı 2/3 eşiğini aştıysa genel kurul sürecini başlat.', 'Bilanço kalemlerini belgelerle doğrula.', 'Tam sürümde aylık izleme, borca batıklık ve yönetim kurulu raporu açılır.'],
  },
  'kkeg-ve-finansman-gider-kisitlamasi-vergi-savunma-seti': {
    ...
    girisBasliklari: ['Kalem', 'Yabancı kaynak (₺)', 'Öz kaynak (₺)', 'Finansman gideri (₺)', 'KKEG (₺)'],
    ornek: [
      ['Kısa vadeli borç', 1850000, 900000, 96000, 48000],
      ['Uzun vadeli borç', 960000, 900000, 72000, 3600],
      ['Kredi faizi', 420000, 900000, 38400, 0],
      ['Kur farkı', 780000, 900000, 28800, 0],
    ],
    metrikler: [
      ['Toplam yabancı kaynak', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam öz kaynak', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Fark (aşan kısım)', '=B6-B7', 'para'],
      ['Toplam KKEG', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Demo karar', '=IF(B9>40000,"DURDUR",IF(B9>10000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['KKEG tutarını dönem matrahına yansıt.', 'Yabancı kaynak ve öz kaynak kalemlerini belgeyle doğrula.', 'Tam sürümde oran hesabı, senaryo ve savunma raporu açılır.'],
  },
  'kdv-iadesi-azami-alacak-hesabi-dosya-hazirlayici': {
    ...
    girisBasliklari: ['Belge', 'Tutar (₺)', 'KDV (₺)', 'İade hakkı', 'Azami iade (₺)'],
    ornek: [
      ['İhracat faturası 1', 650000, 78000, 'Evet', 65000],
      ['İhracat faturası 2', 380000, 45600, 'Evet', 38000],
      ['Yurt içi satış', 240000, 28800, 'Hayır', 0],
      ['Gider pusulası', 48000, 5760, 'Hayır', 0],
    ],
    metrikler: [
      ['Toplam belge tutarı', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam KDV', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['İade hakkı doğuran tutar', '=SUMIF(DEMO_GIRIS!D6:D25,"Evet",DEMO_GIRIS!B6:B25)', 'para'],
      ['Azami iade', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Demo karar', '=IF(B9<B8,"UYGUN",IF(B9=B8,"İNCELE","DURDUR"))', 'metin'],
    ],
    aksiyonlar: ['Eksik belge varsa iade dosyasını tamamla.', 'İade hakkı sınırını güncel mevzuatla doğrula.', 'Tam sürümde belge takibi, sınır hesabı ve dosya kontrolü açılır.'],
  },
  'ortaklar-cari-ve-kasa-adat-faiz-faturasi-hesaplayici': {
    ...
    girisBasliklari: ['Ortak', 'Bakiye (₺)', 'Gün', 'Günlük faiz oranı', 'Faiz (₺)'],
    ornek: [
      ['Ahmet Y.', 850000, 120, 0.000411, 41910],
      ['Mehmet K.', 420000, 90, 0.000411, 15540],
      ['Ayşe D.', 1200000, 150, 0.000411, 73980],
      ['Ali S.', 260000, 60, 0.000411, 6412],
    ],
    metrikler: [
      ['Toplam bakiye', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam faiz', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['KDV (%20)', '=B7*0.20', 'para'],
      ['Fatura tutarı', '=B7+B8', 'para'],
      ['Demo karar', '=IF(B9>100000,"DURDUR",IF(B9>50000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Faiz faturasını ortak bazında düzenle.', 'Gün ve oranları belgelerle doğrula.', 'Tam sürümde adat gün hesabı, dönem takibi ve fatura şablonu açılır.'],
  },
  'doviz-acik-pozisyonu-ve-kur-riski-stres-testi': {
    ...
    girisBasliklari: ['Kalem', 'Varlık (₺)', 'Borç (₺)', 'Döviz cinsi', 'Net pozisyon (₺)'],
    ornek: [
      ['Mevduat', 850000, 0, 'USD', 850000],
      ['İhracat alacağı', 1200000, 0, 'EUR', 1200000],
      ['Kredi', 0, 2400000, 'USD', -2400000],
      ['Tedarikçi borcu', 0, 480000, 'EUR', -480000],
    ],
    metrikler: [
      ['Toplam varlık', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam borç', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Net pozisyon', '=B6-B7', 'para'],
      ['Kur şoku etkisi (%15)', '=B8*0.15', 'para'],
      ['Demo karar', '=IF(B9>500000,"DURDUR",IF(B9>200000,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Açık pozisyonu dengeleyici döviz işlemi değerlendir.', 'Kur şoku senaryosunu AYARLAR oranıyla doğrula.', 'Tam sürümde cins bazlı pozisyon, stres senaryoları ve karar motoru açılır.'],
  },
  'amortisman-ve-sabit-kiymet-satis-zamanlama-stratejisti': {
    ...
    girisBasliklari: ['Kıymet', 'Maliyet (₺)', 'Ömür (yıl)', 'Satış bedeli (₺)', 'Net nakit (₺)'],
    ornek: [
      ['Makine 1', 1200000, 8, 680000, 512000],
      ['Makine 2', 640000, 6, 290000, 205000],
      ['Taşıt 1', 480000, 5, 185000, 132000],
      ['Bina 1', 3200000, 25, 2450000, 1900000],
    ],
    metrikler: [
      ['Toplam maliyet', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam satış bedeli', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Toplam net nakit', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Kâr oranı', '=IFERROR(B7/B6,0)', 'oran'],
      ['Demo karar', '=IF(B8<=0,"DURDUR",IF(B9<0.25,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['En yüksek net nakitli çeyreği satış dönemi olarak değerlendir.', 'Vergi etkisini güncel oranla doğrula.', 'Tam sürümde kıst amortisman, NBD ve dönem karşılaştırması açılır.'],
  },
  'pazaryeri-net-kar-ve-eksik-hakedis-yakalayici': {
    ...
    girisBasliklari: ['Kalem', 'Satış (₺)', 'Gider (₺)', 'Beklenen hakediş (₺)', 'Gerçek hakediş (₺)'],
    ornek: [
      ['Kalem A', 45000, 13500, 31500, 29800],
      ['Kalem B', 28000, 8200, 19800, 19800],
      ['Kalem C', 61000, 19700, 41300, 38900],
      ['Kalem D', 18000, 5400, 12600, 12600],
    ],
    metrikler: [
      ['Toplam satış', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam gider', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Beklenen hakediş', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Fark (eksik tahsilat)', '=B8-SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Demo karar', '=IF(B9>5000,"DURDUR",IF(B9>0,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Eksik hakedişi pazaryeri ile mutabık kıl.', 'Gider kalemlerini belgeyle doğrula.', 'Tam sürümde komisyon kademesi, iade, reklam dağıtımı ve tahmin açılır.'],
  },
  'nakliye-maliyeti-hesaplayici': {
    ...
    girisBasliklari: ['Sefer', 'Km', 'Ton', 'Gelir (₺)', 'Maliyet (₺)'],
    ornek: [
      ['Sefer 1', 620, 18, 38500, 29400],
      ['Sefer 2', 380, 12, 21800, 17200],
      ['Sefer 3', 840, 22, 51200, 39800],
      ['Sefer 4', 460, 15, 25600, 21400],
    ],
    metrikler: [
      ['Toplam gelir', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Toplam maliyet', '=SUM(DEMO_GIRIS!E6:E25)', 'para'],
      ['Net kâr', '=B6-B7', 'para'],
      ['Km başına maliyet', '=IFERROR(B8/SUM(DEMO_GIRIS!B6:B25),0)', 'para'],
      ['Demo karar', '=IF(B8<0,"DURDUR",IF(B8<B7*0.15,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Zararlı seferlerde fiyatlamayı yeniden değerlendir.', 'Yakıt tüketimi ve bakım kalemlerini doğrula.', 'Tam sürümde filo bazlı amortisman, senaryo ve duyarlılık analizi açılır.'],
  },
  'mutfak-kayip-kacak-hesaplayici': {
    ...
    girisBasliklari: ['Hammadde', 'Teorik (kg)', 'Fiili (kg)', 'Kayıp (kg)', 'Kayıp oranı'],
    ornek: [
      ['Domates', 420, 510, 90, '=D6/B6'],
      ['Peynir', 180, 235, 55, '=D7/B7'],
      ['Et', 260, 335, 75, '=D8/B8'],
      ['Un', 380, 445, 65, '=D9/B9'],
    ],
    metrikler: [
      ['Toplam teorik', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam fiili', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Toplam kayıp', '=SUM(DEMO_GIRIS!D6:D25)', 'para'],
      ['Toplam kayıp oranı', '=IFERROR(B8/B7,0)', 'oran'],
      ['Demo karar', '=IF(B9>0.08,"DURDUR",IF(B9>0.03,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Yüksek kayıplı hammaddeyi mutfak sürecinde denetle.', 'Stok ve reçete verisini doğrula.', 'Tam sürümde reçete bazlı tüketim, anomali ve tahmin modülü açılır.'],
  },
  'sube-karlilik-ve-nakit-hesaplayici': {
    ...
    girisBasliklari: ['Şube', 'Gelir (₺)', 'Gider (₺)', 'Net kâr (₺)', 'Marj'],
    ornek: [
      ['İstanbul', 940000, 620000, 320000, '=D6/B6'],
      ['Ankara', 480000, 390000, 90000, '=D7/B7'],
      ['İzmir', 520000, 415000, 105000, '=D8/B8'],
      ['Bursa', 260000, 275000, -15000, '=D9/B9'],
    ],
    metrikler: [
      ['Toplam gelir', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam gider', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Toplam net kâr', '=B6-B7', 'para'],
      ['Genel marj', '=IFERROR(B8/B6,0)', 'oran'],
      ['Demo karar', '=IF(B9<0.05,"DURDUR",IF(B9<0.15,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Zararlı şubelerin gider yapısını denetle.', 'Tahsilat ve ödeme planını gözden geçir.', 'Tam sürümde nakit akışı, senaryo ve duyarlılık analizi açılır.'],
  },
  'uretim-recetesi-ve-zam-yansitma-hesaplayici': {
    ...
    girisBasliklari: ['Ürün', 'Eski maliyet (₺)', 'Yeni maliyet (₺)', 'Artış (₺)', 'Zam oranı'],
    ornek: [
      ['Ürün A', 85, 104, 19, '=D6/B6'],
      ['Ürün B', 42, 51, 9, '=D7/B7'],
      ['Ürün C', 130, 168, 38, '=D8/B8'],
      ['Ürün D', 65, 76, 11, '=D9/B9'],
    ],
    metrikler: [
      ['Toplam eski maliyet', '=SUM(DEMO_GIRIS!B6:B25)', 'para'],
      ['Toplam yeni maliyet', '=SUM(DEMO_GIRIS!C6:C25)', 'para'],
      ['Toplam artış', '=B7-B6', 'para'],
      ['Ortalama zam oranı', '=IFERROR(B8/B6,0)', 'oran'],
      ['Demo karar', '=IF(B9>0.20,"DURDUR",IF(B9>0.08,"İNCELE","UYGUN"))', 'metin'],
    ],
    aksiyonlar: ['Yüksek artışlı ürünlerde fiyatı yeniden hesapla.', 'Fire ve hammadde verisini doğrula.', 'Tam sürümde reçete bazlı hedef marj ve önerilen fiyat açılır.'],
  },
  'asgari-kurumlar-vergisi-simulasyon-motoru': {
    karar: 'Asgari Kurumlar Vergisi Simülasyon Motoru için örnek girdilerle karar ve risk özetini gösterir.',
  ...
  'yeniden-degerleme-komuta-merkezi': {
    karar: 'Yeniden Değerleme Komuta Merkezi (298/Ç + Geç.32) için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'uretim-kari-125-kv-optimizasyonu': {
    karar: 'Üretim Kârı %12,5 KV Optimizasyonu için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'hizmet-ihracati-100-indirim-transfer-takip': {
    karar: 'Hizmet İhracatı %100 İndirim + Transfer Takip için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'e-belge-zorunluluk-radari': {
    karar: 'e-Belge Zorunluluk Radarı için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'yurt-disi-yapilanma-vergi-simulatoru': {
    karar: 'Yurt Dışı Yapılanma Vergi Simülatörü için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'ortulu-sermaye-emsal-faiz-tf-paketi': {
    karar: 'Örtülü Sermaye + Emsal Faiz + TF Paketi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'kdv-iadesi-tutar-surec-simulasyonu': {
    karar: 'KDV İadesi Tutar ve Süreç Simülasyonu için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'kik-asiri-dusuk-savunma-sinir-deger': {
    karar: 'KİK Aşırı Düşük Savunma + Sınır Değer Paketi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'ihale-fiyat-farki-eskalasyon-pro': {
    karar: 'İhale Fiyat Farkı (Eskalasyon) Pro için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'insaat-hakedis-yonetim-sistemi': {
    karar: 'İnşaat Hakediş Yönetim Sistemi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'kat-karsiligi-hasilat-paylasimi-simulator': {
    karar: 'Kat Karşılığı / Hasılat Paylaşımı Simülatör için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'pazaryeri-hakedis-mutabakat-motoru': {
    karar: 'Pazaryeri Hakediş Mutabakat Motoru için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'e-ticaret-gercek-karlilik-fiyatlama': {
    karar: 'E-Ticaret Gerçek Kârlılık & Fiyatlama için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'kargo-desi-maliyet-optimizasyonu': {
    karar: 'Kargo/Desi Maliyet Optimizasyonu için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'on-uc-haftalik-nakit-odeme-onceligi': {
    karar: '13 Haftalık Nakit + Ödeme Önceliği için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'tahsilat-riski-vade-komuta-paneli': {
    karar: 'Tahsilat Riski & Vade Komuta Paneli için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'mizan-anomali-denetim-oncesi-kontrol': {
    karar: 'Mizan Anomali & Denetim Öncesi Kontrol için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'proje-finansmani-dscr-llcr-paketi': {
    karar: 'Proje Finansmanı Paketi (DSCR/LLCR) için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'banka-kredi-covenant-erken-uyari': {
    karar: 'Banka Kredi + Covenant Erken Uyarı için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'sgk-prim-tesvikleri-optimizasyon-motoru': {
    karar: 'SGK Prim Teşvikleri Optimizasyon Motoru için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'puantaj-vardiya-fazla-mesai-kanit-sistemi': {
    karar: 'Puantaj-Vardiya-Fazla Mesai Kanıt Sistemi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'fesih-maliyeti-simulatoru': {
    karar: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade) için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'mini-mrp-bom-malzeme-kapasite': {
    karar: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite) için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'fason-uretim-takip-sistemi': {
    karar: 'Fason Üretim Takip Sistemi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'makine-bakim-kalibrasyon-durus-maliyeti': {
    karar: 'Makine Bakım & Kalibrasyon + Duruş Maliyeti için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'stok-optimizasyon-abc-olu-stok-nakit': {
    karar: 'Stok Optimizasyon + ABC + Ölü Stok Nakit için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'kvkk-veri-envanteri-verbis-uyum': {
    karar: 'KVKK Veri Envanteri + VERBİS Uyum Sistemi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'isg-risk-degerlendirme-pro-6331': {
    karar: 'İSG Risk Değerlendirme Pro (6331) için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'konkordato-ttk376-kriz-paketi': {
    karar: 'Konkordato + TTK 376 Kriz Paketi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'ges-yatirim-fizibilite': {
    karar: 'GES Yatırım Fizibilite Simülatörü için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'elektrik-faturasi-dogrulama': {
    karar: 'Elektrik Faturası Doğrulama Motoru için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'sarj-istasyonu-yatirim': {
    karar: 'Şarj İstasyonu Yatırım Simülatörü için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'ges-uretim-performans': {
    karar: 'GES Üretim & Performans Takibi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'sut-surusu-yonetim': {
    karar: 'Süt Sürüsü Yönetim Komutası için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'yem-rasyonu-maliyet': {
    karar: 'Yem Rasyonu & Maliyet Motoru için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'sera-kurulum-fizibilite': {
    karar: 'Sera Kurulum & Rekolte Fizibilitesi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'tarimsal-destek-uygunluk': {
    karar: 'Tarımsal Destek/Teşvik Uygunluk Testi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'filo-arac-maliyet-komutasi': {
    karar: 'Filo Araç Maliyet Komutası için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'sevkiyat-fiyatlama-navlun': {
    karar: 'Sevkiyat Fiyatlama & Navlun Maliyet Motoru için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'depo-doluluk-lokasyon': {
    karar: 'Depo Doluluk & Lokasyon Optimizasyonu için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'recete-maliyeti-menu-muhendisligi': {
    karar: 'Reçete Maliyeti & Menü Mühendisliği için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'gida-lot-maliyet-izlenebilirlik': {
    karar: 'Gıda Üretim Parti (Lot) Maliyet & İzlenebilirlik için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'site-apartman-yonetim-sistemi': {
    karar: 'Site/Apartman Yönetim Sistemi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'kira-portfoyu-getiri-komutasi': {
    karar: 'Kira Portföyü Getiri Komutası için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'emlak-pipeline-komisyon': {
    karar: 'Emlak Ofisi Satış Pipeline & Komisyon Takibi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'dernek-kooperatif-mali-yonetim': {
    karar: 'Dernek/Kooperatif Mali Yönetim Sistemi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'dava-masraf-harc-hesaplama': {
    karar: 'Dava Masraf & Harç Hesaplama Motoru için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'hukuk-burosu-dosya-vekalet': {
    karar: 'Hukuk Bürosu Dosya & Vekalet Komutası için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'spc-proses-yetenek-analizi': {
    karar: 'SPC Proses Yetenek Analizi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'oee-durus-kok-neden-komutasi': {
    karar: 'OEE & Duruş Kök-Neden Komutası için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'sekiz-d-duzeltici-faaliyet-dosya': {
    karar: '8D / Düzeltici Faaliyet Dosya Sistemi için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'ithalat-landed-cost-motoru': {
    karar: 'İthalat Landed Cost Motoru için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
  ...
  'ihracat-siparis-karlilik-kur': {
    karar: 'İhracat Sipariş Kârlılık & Kur Riski Komutası için örnek girdilerle karar ve risk özetini gösterir.',
    girisBasliklari: ['Kalem', 'Tutar (₺)', 'Oran (%)', 'Risk', 'Not'],
    ornek: [
      ['Kalem A', 120000, 12, 'Düşük', 'Örnek'],
      ['Kalem B', 85000, 8, 'Orta', 'Örnek'],
