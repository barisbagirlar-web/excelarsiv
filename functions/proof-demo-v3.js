...
<dxfs count="4"><dxf><fill><patternFill patternType="solid"><fgColor rgb="FFE5F5EC"/></patternFill></fill><font><color rgb="${PALETTE.positive}"/><b/></font></dxf><dxf><fill><patternFill patternType="solid"><fgColor rgb="FFFFF4D6"/></patternFill></fill><font><color rgb="${PALETTE.warning}"/><b/></font></dxf><dxf><fill><patternFill patternType="solid"><fgColor rgb="FFFDECEC"/></patternFill></fill><font><color rgb="${PALETTE.risk}"/><b/></font></dxf><dxf><fill><patternFill patternType="solid"><fgColor rgb="FFFFE6E6"/></patternFill></fill></dxf></dxfs>
</styleSheet>`;
}
function workbookXml(sheets) { return `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><workbookPr date1904="0"/><workbookProtection workbookPassword="${SHEET_PASSWORD_HASH}" lockStructure="1"/><sheets>${sheets.map((s,i)=>`<sheet name="${esc(s.name)}" sheetId="${i+1}" r:id="rId${i+1}"/>`).join('')}</sheets><calcPr calcId="191029" calcMode="auto" fullCalcOnLoad="1" forceFullCalc="1"/></workbook>`; }
