---
name: 'Mizan Anomali & Denetim Öncesi Kontrol'
summary: 'Mizan Anomali & Denetim Öncesi Kontrol ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Mizan Anomali & Denetim Öncesi Kontrol ne işe yarar?'
    answer: 'Mizan Anomali & Denetim Öncesi Kontrol ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/mizan-anomali-denetim-oncesi-kontrol-1.png'
    alt: 'Mizan Anomali & Denetim Öncesi Kontrol dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/mizan-anomali-denetim-oncesi-kontrol-2.png'
    alt: 'Mizan Anomali & Denetim Öncesi Kontrol dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/mizan-anomali-denetim-oncesi-kontrol-3.png'
    alt: 'Mizan Anomali & Denetim Öncesi Kontrol dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
