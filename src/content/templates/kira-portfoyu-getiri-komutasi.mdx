...
summary: 'Kira Portföyü Getiri Komutası ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Kira Portföyü Getiri Komutası ne işe yarar?'
    answer: 'Kira Portföyü Getiri Komutası ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/kira-portfoyu-getiri-komutasi-1.png'
    alt: 'Kira Portföyü Getiri Komutası dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/kira-portfoyu-getiri-komutasi-2.png'
    alt: 'Kira Portföyü Getiri Komutası dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/kira-portfoyu-getiri-komutasi-3.png'
    alt: 'Kira Portföyü Getiri Komutası dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
