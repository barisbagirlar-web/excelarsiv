---
name: 'Proje Finansmanı Paketi (DSCR/LLCR)'
summary: 'Proje Finansmanı Paketi (DSCR/LLCR) ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Proje Finansmanı Paketi (DSCR/LLCR) ne işe yarar?'
    answer: 'Proje Finansmanı Paketi (DSCR/LLCR) ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/proje-finansmani-dscr-llcr-paketi-1.png'
    alt: 'Proje Finansmanı Paketi (DSCR/LLCR) dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/proje-finansmani-dscr-llcr-paketi-2.png'
    alt: 'Proje Finansmanı Paketi (DSCR/LLCR) dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/proje-finansmani-dscr-llcr-paketi-3.png'
    alt: 'Proje Finansmanı Paketi (DSCR/LLCR) dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
