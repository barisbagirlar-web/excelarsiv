...
summary: 'OEE & Duruş Kök-Neden Komutası ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'OEE & Duruş Kök-Neden Komutası ne işe yarar?'
    answer: 'OEE & Duruş Kök-Neden Komutası ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/oee-durus-kok-neden-komutasi-1.png'
    alt: 'OEE & Duruş Kök-Neden Komutası dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/oee-durus-kok-neden-komutasi-2.png'
    alt: 'OEE & Duruş Kök-Neden Komutası dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/oee-durus-kok-neden-komutasi-3.png'
    alt: 'OEE & Duruş Kök-Neden Komutası dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
