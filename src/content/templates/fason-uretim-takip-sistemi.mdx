---
name: 'Fason Üretim Takip Sistemi'
summary: 'Fason Üretim Takip Sistemi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Fason Üretim Takip Sistemi ne işe yarar?'
    answer: 'Fason Üretim Takip Sistemi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/fason-uretim-takip-sistemi-1.png'
    alt: 'Fason Üretim Takip Sistemi dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/fason-uretim-takip-sistemi-2.png'
    alt: 'Fason Üretim Takip Sistemi dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/fason-uretim-takip-sistemi-3.png'
    alt: 'Fason Üretim Takip Sistemi dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
