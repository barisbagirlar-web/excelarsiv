---
name: 'Üretim Kârı %12,5 KV Optimizasyonu'
summary: 'Üretim Kârı %12,5 KV Optimizasyonu ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Üretim Kârı %12,5 KV Optimizasyonu ne işe yarar?'
    answer: 'Üretim Kârı %12,5 KV Optimizasyonu ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/uretim-kari-125-kv-optimizasyonu-1.png'
    alt: 'Üretim Kârı %12,5 KV Optimizasyonu dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/uretim-kari-125-kv-optimizasyonu-2.png'
    alt: 'Üretim Kârı %12,5 KV Optimizasyonu dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/uretim-kari-125-kv-optimizasyonu-3.png'
    alt: 'Üretim Kârı %12,5 KV Optimizasyonu dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
