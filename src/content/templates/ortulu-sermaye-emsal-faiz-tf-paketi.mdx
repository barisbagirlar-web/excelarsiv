...
summary: 'Örtülü Sermaye + Emsal Faiz + TF Paketi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Örtülü Sermaye + Emsal Faiz + TF Paketi ne işe yarar?'
    answer: 'Örtülü Sermaye + Emsal Faiz + TF Paketi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/ortulu-sermaye-emsal-faiz-tf-paketi-1.png'
    alt: 'Örtülü Sermaye + Emsal Faiz + TF Paketi dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/ortulu-sermaye-emsal-faiz-tf-paketi-2.png'
    alt: 'Örtülü Sermaye + Emsal Faiz + TF Paketi dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/ortulu-sermaye-emsal-faiz-tf-paketi-3.png'
    alt: 'Örtülü Sermaye + Emsal Faiz + TF Paketi dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
