---
name: 'e-Belge Zorunluluk Radarı'
summary: 'e-Belge Zorunluluk Radarı ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'e-Belge Zorunluluk Radarı ne işe yarar?'
    answer: 'e-Belge Zorunluluk Radarı ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/e-belge-zorunluluk-radari-1.png'
    alt: 'e-Belge Zorunluluk Radarı dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/e-belge-zorunluluk-radari-2.png'
    alt: 'e-Belge Zorunluluk Radarı dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/e-belge-zorunluluk-radari-3.png'
    alt: 'e-Belge Zorunluluk Radarı dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
