---
name: 'Pazaryeri Hakediş Mutabakat Motoru'
summary: 'Pazaryeri Hakediş Mutabakat Motoru ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Pazaryeri Hakediş Mutabakat Motoru ne işe yarar?'
    answer: 'Pazaryeri Hakediş Mutabakat Motoru ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/pazaryeri-hakedis-mutabakat-motoru-1.png'
    alt: 'Pazaryeri Hakediş Mutabakat Motoru dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/pazaryeri-hakedis-mutabakat-motoru-2.png'
    alt: 'Pazaryeri Hakediş Mutabakat Motoru dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/pazaryeri-hakedis-mutabakat-motoru-3.png'
    alt: 'Pazaryeri Hakediş Mutabakat Motoru dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
