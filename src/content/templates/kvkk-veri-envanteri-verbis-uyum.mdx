...
summary: 'KVKK Veri Envanteri + VERBİS Uyum Sistemi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'KVKK Veri Envanteri + VERBİS Uyum Sistemi ne işe yarar?'
    answer: 'KVKK Veri Envanteri + VERBİS Uyum Sistemi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/kvkk-veri-envanteri-verbis-uyum-1.png'
    alt: 'KVKK Veri Envanteri + VERBİS Uyum Sistemi dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/kvkk-veri-envanteri-verbis-uyum-2.png'
    alt: 'KVKK Veri Envanteri + VERBİS Uyum Sistemi dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/kvkk-veri-envanteri-verbis-uyum-3.png'
    alt: 'KVKK Veri Envanteri + VERBİS Uyum Sistemi dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
