---
name: 'Dava Masraf & Harç Hesaplama Motoru'
summary: 'Dava Masraf & Harç Hesaplama Motoru ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Dava Masraf & Harç Hesaplama Motoru ne işe yarar?'
    answer: 'Dava Masraf & Harç Hesaplama Motoru ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/dava-masraf-harc-hesaplama-1.png'
    alt: 'Dava Masraf & Harç Hesaplama Motoru dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/dava-masraf-harc-hesaplama-2.png'
    alt: 'Dava Masraf & Harç Hesaplama Motoru dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/dava-masraf-harc-hesaplama-3.png'
    alt: 'Dava Masraf & Harç Hesaplama Motoru dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
