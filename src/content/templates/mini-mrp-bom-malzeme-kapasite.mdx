---
name: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite)'
summary: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite) ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite) ne işe yarar?'
    answer: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite) ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/mini-mrp-bom-malzeme-kapasite-1.png'
    alt: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite) dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/mini-mrp-bom-malzeme-kapasite-2.png'
    alt: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite) dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/mini-mrp-bom-malzeme-kapasite-3.png'
    alt: 'Mini-MRP (BOM + Malzeme İhtiyacı + Kapasite) dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
