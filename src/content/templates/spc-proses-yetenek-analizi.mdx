...
summary: 'SPC Proses Yetenek Analizi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'SPC Proses Yetenek Analizi ne işe yarar?'
    answer: 'SPC Proses Yetenek Analizi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/spc-proses-yetenek-analizi-1.png'
    alt: 'SPC Proses Yetenek Analizi dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/spc-proses-yetenek-analizi-2.png'
    alt: 'SPC Proses Yetenek Analizi dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/spc-proses-yetenek-analizi-3.png'
    alt: 'SPC Proses Yetenek Analizi dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
