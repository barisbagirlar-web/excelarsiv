...
summary: 'İnşaat Hakediş Yönetim Sistemi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'İnşaat Hakediş Yönetim Sistemi ne işe yarar?'
    answer: 'İnşaat Hakediş Yönetim Sistemi ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/insaat-hakedis-yonetim-sistemi-1.png'
    alt: 'İnşaat Hakediş Yönetim Sistemi dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/insaat-hakedis-yonetim-sistemi-2.png'
    alt: 'İnşaat Hakediş Yönetim Sistemi dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/insaat-hakedis-yonetim-sistemi-3.png'
    alt: 'İnşaat Hakediş Yönetim Sistemi dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
