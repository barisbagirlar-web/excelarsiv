---
name: 'SGK Prim Teşvikleri Optimizasyon Motoru'
summary: 'SGK Prim Teşvikleri Optimizasyon Motoru ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'SGK Prim Teşvikleri Optimizasyon Motoru ne işe yarar?'
    answer: 'SGK Prim Teşvikleri Optimizasyon Motoru ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/sgk-prim-tesvikleri-optimizasyon-motoru-1.png'
    alt: 'SGK Prim Teşvikleri Optimizasyon Motoru dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/sgk-prim-tesvikleri-optimizasyon-motoru-2.png'
    alt: 'SGK Prim Teşvikleri Optimizasyon Motoru dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/sgk-prim-tesvikleri-optimizasyon-motoru-3.png'
    alt: 'SGK Prim Teşvikleri Optimizasyon Motoru dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
