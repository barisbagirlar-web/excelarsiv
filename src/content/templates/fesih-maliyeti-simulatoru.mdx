---
name: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade)'
summary: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade) ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade) ne işe yarar?'
    answer: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade) ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/fesih-maliyeti-simulatoru-1.png'
    alt: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade) dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/fesih-maliyeti-simulatoru-2.png'
    alt: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade) dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/fesih-maliyeti-simulatoru-3.png'
    alt: 'Fesih Maliyeti Simülatörü (kıdem+ihbar+işe iade) dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
