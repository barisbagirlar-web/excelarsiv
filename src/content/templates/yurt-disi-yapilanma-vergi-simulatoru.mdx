---
name: 'Yurt Dışı Yapılanma Vergi Simülatörü'
summary: 'Yurt Dışı Yapılanma Vergi Simülatörü ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'Yurt Dışı Yapılanma Vergi Simülatörü ne işe yarar?'
    answer: 'Yurt Dışı Yapılanma Vergi Simülatörü ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/yurt-disi-yapilanma-vergi-simulatoru-1.png'
    alt: 'Yurt Dışı Yapılanma Vergi Simülatörü dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/yurt-disi-yapilanma-vergi-simulatoru-2.png'
    alt: 'Yurt Dışı Yapılanma Vergi Simülatörü dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/yurt-disi-yapilanma-vergi-simulatoru-3.png'
    alt: 'Yurt Dışı Yapılanma Vergi Simülatörü dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
