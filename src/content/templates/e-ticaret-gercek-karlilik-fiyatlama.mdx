...
summary: 'E-Ticaret Gerçek Kârlılık & Fiyatlama ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
faq: 
  - question: 'E-Ticaret Gerçek Kârlılık & Fiyatlama ne işe yarar?'
    answer: 'E-Ticaret Gerçek Kârlılık & Fiyatlama ile girdilerinizi işleyin; karar, risk ve yönetici özetini tek dosyada görün.'
...
screenshots: 
  - src: '/screenshots/e-ticaret-gercek-karlilik-fiyatlama-1.png'
    alt: 'E-Ticaret Gerçek Kârlılık & Fiyatlama dosyasının giriş sayfası — veri girişi ve parametreler'
  - src: '/screenshots/e-ticaret-gercek-karlilik-fiyatlama-2.png'
    alt: 'E-Ticaret Gerçek Kârlılık & Fiyatlama dosyasının karar sayfası — karar kapısı ve gerekçe'
  - src: '/screenshots/e-ticaret-gercek-karlilik-fiyatlama-3.png'
    alt: 'E-Ticaret Gerçek Kârlılık & Fiyatlama dosyasının pano sayfası — KPI ve yönetici özeti'
related: 
